...
public class ExceptionMessages {
    ...
    public static final String classResourceNotExist = "Class Resource does not exist. Please make sure that you are using the right UID or please make another class diagram request";
